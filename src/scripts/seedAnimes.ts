...
const animeSeedData = [
	{
		...
		rating: "12+",
		duration: "1h 49m",
		imageUrl: "narutoShippuden-poster.webp",
		backgroundImage: "narutoShippuden-background.webp",
		poster: "narutoShippuden-poster.webp",
	},
	{
		title: "Demon Slayer",
		synopsis:
		...
		rating: "16+",
		duration: "1h 26m",
		imageUrl: "demonSlayer-poster.webp",
		backgroundImage: "demonSlayer-background-2.webp",
		poster: "demonSlayer-poster.webp",
	},
	{
		...
		rating: "16+",
		duration: "1h 45m",
		imageUrl: "jujutsuKaisen-poster.webp",
		backgroundImage: "jujutsuKaisen-background.webp",
		poster: "jujutsuKaisen-poster.webp",
	},
	{
		...
		rating: "16+",
		duration: "1h 57m",
		imageUrl: "attackOnTitan-poster.webp",
		backgroundImage: "attackOnTitan-background.webp",
		poster: "attackOnTitan-poster.webp",
	},
	{
		...
		rating: "12+",
		duration: "1h 30m",
		imageUrl: "sousouNoFrieren-poster.webp",
		backgroundImage: "sousouNoFrieren-background.webp",
		poster: "sousouNoFrieren-poster.webp",
	},
];
...
async function seedAnimes() {
	try {
		...
		if (count > 0) {
			console.log(
				`⚠️  Database already has ${count} animes. Skipping seed.`
			);
